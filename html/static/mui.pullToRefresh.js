	...
	$.PullToRefresh = $.Class.extend({
		...
		pullDownLoading: function() {
			...
			this.options.down.callback.apply(this);
			 this.pullUpTipsIcon.innerHTML = this.options.up.contentdown;//吉
		},
		...
		endPullUpToRefresh: function(finished) {
			if (finished) {
//吉				this.finished = true; 
				this.pullUpTipsIcon.innerHTML = this.options.up.contentnomore;
//吉				this.element.removeEventListener('dragup', this);
//吉				window.removeEventListener('scroll', this);
			} else {
